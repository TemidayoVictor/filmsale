            ...
            <div class="form">
                ...
                <form action="{{ route('addMovie') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text"placeholder="Name of Movie" name="name" value="{{ old('name') }}" style="@error('name') border: 1px solid red; @enderror" >     
                    </div>
                    ...
                    <div class="input-field">
                        ...
                        <textarea type="text"placeholder="Movie Description" name="description" value="{{ old('description') }}" style="@error('description') border: 1px solid red; @enderror">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="input-field">
                        ...
                        <select name="genre" id="" value="{{ old('genre') }}" style="@error('genre') border: 1px solid red; @enderror">
                            <option value="@if(!empty(old('genre'))){{ old('genre') }} @else {{ "" }} @endif">@if(!empty(old('genre'))){{ old('genre') }} @else Choose Genre @endif</option>
                    ...
                    <div class="input-field">
                        ...
                        <input type="file" accept="image/*" name="image" value="{{ old('image') }}" style="@error('image') border: 1px solid red; @enderror">     
                    </div>
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="price" value="{{ old('price') }}" style="@error('price') border: 1px solid red; @enderror">     
                    </div>
